...
def main(downloadpath):
    ...
    try:
        ...
        visible = True
        excel = win32.DispatchEx('Excel.Application')#Objeto de Excel
        ...
        print(lista)
        imgfilespath = downloadpath +'\\Sources'+ '\\Images'#Ruta donde se guardarán las imágenes que serán enviadas en los correos
        ...
        for lis in lista[1:]:
            ...
            files_items = os.listdir(downloadpath+ '\\Sources'+'\\Images')#Lista de imágenes que hay en la carpeta
    ...
    #         imageswidth_t,imagesheight_t = tarsConstruct_debugs_.extract_images_from_zip(zipfilename,imagespath=imgfilespath,imgchunk=6)
    ...
    #         tarsConstruct_debugs_.send_mail(sendto, ccto, subject,body, market=1, files=files, use_tls=True, imgfiles=bodyimgfiles)
